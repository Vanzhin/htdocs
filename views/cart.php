<div id="main">
    ...
    <div class="gallery_item">
        ...
        <?php foreach($basketData as $good):?>
            <div class="feedback-item feedback" id="product-<?=$good['product_id']?>" >
                ...
                <p><?=$good['name']?></p>
                <p id = "quantity-<?=$good['product_id']?>"><?=$good['quantity']?></p>
                <p ><?=$good['price']?></p>
                <P><?=$good['totalPrice']?></P>
        ...
        elem.addEventListener('click',(e) =>{
            ...
            (
                async () =>{
                    ...
                    if (answer.status === 'ok'){
                        if (answer.productTotal == 0){
                            document.getElementById('product-' + id).remove();
                        } else {
                            document.getElementById('quantity-' + id).innerHTML =  answer.productTotal;
                        }
